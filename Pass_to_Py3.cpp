...
{	 
	...
	if (!(PyRun_SimpleString("import just_plot3")))
	{
	...
	// ts1, ts2        - the temperature sensors' readings embedded in the stream                      // 
    ...
    //read_in.open("C:/Users/LabCad2/Desktop/MVE_TestBox_PSU_FakeData_Try3_2017_07_19_193859_Card0.tad", std::ios::in|std::ios::binary|std::ios::ate);
    read_in.open("C:/Users/PSU_Telemetry/Documents/WORKPLACE(CHRIS)/Python/r_bytes3.tad", std::ios::in|std::ios::binary|std::ios::ate);
