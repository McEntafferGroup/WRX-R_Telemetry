...
{	 
	...
	*/
	...
	//=================================================================================================//
	PyObject* PREVIOUS = PyObject_CallFunctionObjArgs(make_list, det_size, NULL);
						...
						else
						{
							...
							if (word == e1234)
							{
								...
								if ((row == num_row - 1)&&(graphing))
								{
									...
									//===================================================================================================//
									PyObject_CallFunctionObjArgs(sub_plot, PREVIOUS, DATA, FRAME_NUMBER, first_or_second, lt, ts0, ts1, NULL);
